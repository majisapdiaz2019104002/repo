...
<li class="active"><a href="admin"><i class="icon icon-user"></i> <span>Manage Admin dan Dosen</span></a> </li>
...
<div id="content">
	<div id="content-header">
		<div id="breadcrumb"> <a href="home" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a
				href="admin" class="current">Admin dan Dosen</a> </div>
		<h1><span class="icon-briefcase"></span>
			Manajemen <small>Data Mahasiswa</small></h1>
	</div>
	<hr>
