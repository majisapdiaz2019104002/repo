...
<li><a href="admin"><i class="icon icon-user"></i> <span>Manage Admin dan Dosen</span></a> </li>
		...
		<div class="row-fluid span12">
			<div class="quick-actions_homepage">
				<ul class="quick-actions">
					<li class="bg_lg span3"> <a href="subbuatsoal"> <i class="icon-book"></i>Buat Soal </a> </li>
