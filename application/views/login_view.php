...
body { 
	...
	/* background-image: url ('http://localhost/online/assets/img/LOGIN2.jpg'); */
	background: url('http://localhost/elearning/assets/img/LOGIN2.jpg');
	/* Full height */
	height: 100%; 
...
<body>
	<div class="login">
		...
		<?php $has_error = validation_errors()?"has-error":""; ?>
			<input type="text" name="userid" id="userid" placeholder="ID" required="required" />
			<?= form_error("userid"); ?>
