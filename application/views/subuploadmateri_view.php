		...
		<div class="row-fluid">
			<div class="quick-actions_homepage offset2">
				<ul class="quick-actions">
					<li class="bg_lb span3"> <a href="subuploadmateri"> <i class="icon-book"></i>Upload Materi PDF
						</a> </li>
			...
			<div class="span8 offset2">
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<form action="subuploadmateri/do_upload" class="form-horizontal" enctype="multipart/form-data"
							method="POST">
							...
							<div class="control-group">
								...
								<div class="controls">
									<select class="span11" name="matakuliah" id="matakuliah">
							...
							<!-- <div class="control-group">
								<label class="control-label" for="prodi"><strong>Program Studi</strong></label>
								<div class="controls">
							...
							<div class="control-group">
								<label class="control-label" for="semester"><strong>Semester</strong></label>
								<div class="controls">
							...
							<div class="control-group">
								...
								<div class="controls">
									<input accept=".pdf" type="file" id="upload" name="upload" />
									<br>
